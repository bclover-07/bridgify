...
const ThreeModel = dynamic(() => import('@/components/shared/ThreeModel'), {
  ssr: false,
  loading: () => <div className="w-full h-[400px] bg-[var(--paper)] border-[4px] border-[var(--ink)] flex items-center justify-center font-bold text-lg">Loading 3D Engine...</div>
});
const fadeInUp = {
...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[var(--paper)] overflow-hidden">
      {/* Navigation */}
      <nav className="w-full flex items-center justify-between p-6 border-b-[4px] border-[var(--ink)] bg-white sticky top-0 z-50">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full bg-[var(--electric)] border-[4px] border-[var(--ink)] flex items-center justify-center">
      ...
      <main className="flex-1">
        {/* HERO SECTION */}
        <section className="px-6 py-20 md:py-24 flex items-center relative min-h-[85vh]">
          ...
          <div className="max-w-7xl mx-auto w-full relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full border-[4px] border-[var(--ink)] bg-[var(--acid)] mb-8 shadow-[6px_6px_0px_0px_var(--ink)] font-bold text-sm transform -rotate-2">
              ...
              <motion.p variants={fadeInUp} className="text-xl text-gray-700 mb-10 font-medium">
              ...
              <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <Link href="/login" className="w-full sm:w-auto">
                  <NeuButton variant="primary" size="lg" className="w-full text-lg px-8 py-4">Enter Demo Environment</NeuButton>
                </Link>
                <Link href="#dashboards" className="w-full sm:w-auto">
                  <NeuButton variant="ghost" size="lg" className="w-full text-lg px-8 py-4 bg-white">Explore Dashboards</NeuButton>
                </Link>
              </motion.div>
            </motion.div>
        ...
        {/* THE PROBLEM */}
        <section className="px-6 py-24 bg-[var(--ink)] text-white border-y-[4px] border-[var(--ink)] relative">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="relative">
                <div className="absolute inset-0 bg-[var(--electric)] rounded-2xl transform translate-x-4 translate-y-4 border-[4px] border-black"></div>
                <div className="relative bg-[var(--paper)] text-[var(--ink)] p-8 rounded-2xl border-[4px] border-black font-mono">
                  <div className="flex items-center gap-2 mb-6 border-b-[4px] border-black pb-4">
            ...
            >
              ...
              <motion.div variants={fadeInUp}>
                <NeuCard className="h-full bg-white relative overflow-hidden group">
                  ...
                  <div className="relative z-10 p-8">
                    <div className="w-16 h-16 rounded-2xl bg-[var(--electric)] border-[4px] border-[var(--ink)] flex items-center justify-center text-white mb-6 shadow-[10px_10px_0px_0px_var(--ink)]">
              ...
              <motion.div variants={fadeInUp}>
                <NeuCard className="h-full bg-white relative overflow-hidden group">
                  ...
                  <div className="relative z-10 p-8">
                    <div className="w-16 h-16 rounded-2xl bg-[var(--sky)] border-[4px] border-[var(--ink)] flex items-center justify-center text-[var(--ink)] mb-6 shadow-[10px_10px_0px_0px_var(--ink)]">
              ...
              <motion.div variants={fadeInUp}>
                <NeuCard className="h-full bg-white relative overflow-hidden group">
                  ...
                  <div className="relative z-10 p-8">
                    <div className="w-16 h-16 rounded-2xl bg-[var(--violet)] border-[4px] border-[var(--ink)] flex items-center justify-center text-white mb-6 shadow-[10px_10px_0px_0px_var(--ink)]">
                      <FaBuilding size={28} />
                    </div>
              ...
              <motion.div variants={fadeInUp}>
                <NeuCard className="h-full bg-white relative overflow-hidden group">
                  ...
                  <div className="relative z-10 p-8">
                    <div className="w-16 h-16 rounded-2xl bg-[var(--hotpink)] border-[4px] border-[var(--ink)] flex items-center justify-center text-white mb-6 shadow-[10px_10px_0px_0px_var(--ink)]">
                      <FaUserTie size={28} />
                    </div>
        ...
        {/* TECH STACK SECTION */}
        <section className="px-6 py-24 border-y-[4px] border-[var(--ink)] bg-[var(--mint)]">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="bg-white border-[4px] border-[var(--ink)] p-6 rounded-[24px] shadow-[10px_10px_0px_0px_var(--ink)] transform transition hover:-translate-y-2">
                  <div className="w-14 h-14 bg-[var(--paper)] rounded-full flex items-center justify-center border-[4px] border-[var(--ink)] mx-auto mb-4">
                    {item.icon}
                  </div>
        ...
        <section className="px-6 py-32 bg-[var(--paper)] text-center relative overflow-hidden">
          <div className="absolute top-10 left-10 w-24 h-24 bg-[var(--acid)] rounded-full border-[4px] border-[var(--ink)] animate-bounce" style={{ animationDuration: '3s' }}></div>
          <div className="absolute bottom-10 right-10 w-32 h-32 bg-[var(--electric)] rounded-none transform rotate-12 border-[4px] border-[var(--ink)]"></div>
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <Link href="/login">
              <NeuButton variant="primary" size="lg" className="text-xl px-12 py-5 bg-[var(--electric)] hover:bg-blue-700 w-full sm:w-auto shadow-[10px_10px_0px_0px_var(--ink)]">
      ...
      {/* FOOTER */}
      <footer className="border-t-[4px] border-[var(--ink)] bg-white p-8">
